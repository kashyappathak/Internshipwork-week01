...
<body style="background-image: url('./kunal.jpg');">
    <div class="container my-4">
        ...
        $sqlSelect = "SELECT * FROM category1";
        $result = mysqli_query($conn,$sqlSelect);
        while($data = mysqli_fetch_array($result)){
            ?>
                <tr>
                    <td style="font-weight:bold;"><?php echo $data['id']; ?></td>
                    <td style="font-weight:bold;"><?php echo $data['title']; ?></td>
                    <td style="font-weight:bold;"><?php echo $data['price']; ?></td>
                    <td style="font-weight:bold;"><?php echo $data['sku']; ?></td>
