        ...
        <form id="myForm" action="process.php" method="post">
            ...
            <div class="form-elemnt my-4">
                <input type="text" class="form-control" style="border:4px solid black;" name="name"
                    placeholder="Proct name:" value="<?php echo $row["id"]; ?>">
            </div>
            ...
            <div class="form-elemnt my-4">
                <select name="type" id="" class="form-control" style="border:4px solid black;" required>
                    ...
                    <option value="Laptops" <?php if($row["type"]=="Laptop"){echo "selected";} ?>>Laptop
                    </option>
                </select>
            </div>
            <div class="form-element my-4">
                <input type="file" name="file" id="" class="form-control" placeholder="File"
                    style="border:4px solid black;color:white;" required><?php echo $row["image"]; ?></textarea>
            </div>
            <div class="form-element my-4">
